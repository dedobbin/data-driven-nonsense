GCC=g++
OBJ = behavior_component.o entity.o game.o visuals.o action.o sdl_utils.o physics_component.o gravity_component.o collision_component.o observer.o input.o
COMPILER_FLAGS = -g -w
